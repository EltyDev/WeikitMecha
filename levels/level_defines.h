...
DEFINE_LEVEL("GYM", LEVEL_GYM, COURSE_GYM, gym, generic, 20000, 0x00, 0x00, 0x00, _, sCamGym) 
DEFINE_LEVEL("WELKIT_CASTLE_PAST", LEVEL_WELKIT_CASTLE_PAST, COURSE_WELKIT_CASTLE_PAST, welkit_castle_past, generic, 20000, 0x00, 0x00, 0x00, _, sCamWelkitCastlePast) 
DEFINE_LEVEL("PRINCE_VALLEY", LEVEL_PRINCE_VALLEY, COURSE_PRINCE_VALLEY, prince_valley, generic, 20000, 0x00, 0x00, 0x00, _, sCamPrinceValley) 
DEFINE_LEVEL("CATAMESA", LEVEL_CATAMESA, COURSE_CATAMESA, catamesa, generic, 20000, 0x00, 0x00, 0x00, _, sCamCatamesa) 
DEFINE_LEVEL("WELKIT_CITY", LEVEL_WELKIT_CITY, COURSE_WELKIT_CITY, welkit_city, generic, 20000, 0x00, 0x00, 0x00, _, sCamWelkitCity) 