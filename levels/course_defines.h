...
DEFINE_COURSE(COURSE_WELKIT_CASTLE_PAST, 0x44444440) 
DEFINE_COURSE(COURSE_PRINCE_VALLEY, 0x44444440) 
DEFINE_COURSE(COURSE_CATAMESA, 0x44444440) 
DEFINE_COURSE(COURSE_WELKIT_CITY, 0x44444440) 
DEFINE_COURSES_END()
...
DEFINE_BONUS_COURSE(COURSE_GYM, 0x44444440) // (26) Test