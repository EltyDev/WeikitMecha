...
const LevelScript level_welkit_castle_past_entry[] = {
	...
	AREA(1, welkit_castle_past_area_1),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 0, 0, -600, 0, 0, 0, 0x00000000, bhvWarpPipe),
		...
		OBJECT(MODEL_YELLOW_COIN, 0, 11300, 0, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_RED_COIN, 0, 11300, 0, 0, 0, 0, 0x00000000, bhvRedCoin),
